class AcaosController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to acaos_path, status: :see_other, notice: "Acao was successfully destroyed." }
  ...
  private
    ...
    def set_acao
      @acao = Acao.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def acao_params
      params.expect(acao: [ :descricao, :pontos_obtidos ])
    end
end
