...
class AcaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create acao" do
    assert_difference("Acao.count") do
      post acaos_url, params: { acao: { descricao: @acao.descricao, pontos_obtidos: @acao.pontos_obtidos } }
    end
  ...
  test "should update acao" do
    patch acao_url(@acao), params: { acao: { descricao: @acao.descricao, pontos_obtidos: @acao.pontos_obtidos } }
